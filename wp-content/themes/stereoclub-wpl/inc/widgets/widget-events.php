	...
	public function widget( $args, $instance ) {
		...
		?>
			...
			<?php if( $events->have_posts() ) : ?>
				<!-- Widget Events -->
				<aside id="event-small-<?php the_ID(); ?>" class="WPlookeventssmall widgets">
					...
					?>
						<div class="toggle-event">
							<div class="expand-button">
								<time datetime="<?php echo date('c',strtotime($event_date)); ?>" class="fleft"><?php echo date_i18n( get_option('date_format'), strtotime($event_date) ); ?></time>
								<span class="category-selected fright"><a href="#"><?php echo date_i18n( 'D', strtotime($event_date) ); ?></a></span>
							</div>
							<div class="expand">
